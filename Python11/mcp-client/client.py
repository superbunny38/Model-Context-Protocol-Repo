...
class MCPClient:
    def __init__(self):
        # Initialize sssion and client objects
        self.session: Optional[ClientSession] = None
        self.exit_staack = AsyncExitStack()
    ...
    async def connect_to_server(self, server_script_path: str):
        ...
        Args:
            server_script_path (str): path to the server script (.py file)
        """
        ...
        stdio_transport = await self.exit_staack.enter_async_context(stdio_client(server_params))
        self.stdio, self.write = stdio_transport
        self.session = await self.exit_staack.enter_async_context(ClientSession(self.stdio,self.write))
