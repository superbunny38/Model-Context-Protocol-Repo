    ...
    async def process_query(self, query: str) -> str:
        ...
        if assistant_message.tool_calls:
            ...
            final_response = await self.openai_client.chat.completions.create(
                ...
                messages = messages,
                tools = tools,
                tool_choice= "none",# Don't allow for more tool calls
            )
...
async def main():
    ...
    client = MCPOpenAIClient()# establish client by creating an instance
    await client.connect_to_server("server.py")#connect to server
